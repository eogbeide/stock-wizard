...
st.write(forecast[['ds', 'yhat_lower', 'yhat', 'yhat_upper']].tail(10)).set_index(forecast.columns[0])
#st.write(forecast[['ds', 'yhat_lower', 'yhat_upper']].tail(30)).set_index(forecast.columns[0])
