...
def interactive_plot_forecasting(df, forecast, title):
    ...
    fig.add_trace(go.Scatter(x=forecast.index, y=forecast['yhat_lower'], mode='lines', name='yhat_lower'))
    fig.add_trace(go.Scatter(x=forecast.index, y=forecast['yhat_upper'], mode='lines', name='yhat_upper'))
