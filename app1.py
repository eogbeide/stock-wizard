...
for df, title, ticker in zip(dfs, titles, tickers):
    ...
    st.write(" - yhat is the median price. yhat_lower is the lowest price. Actual price below yhat_lower signals a buying opportunity.")
    st.write(" - yhat is the median price. yhat_upper is the highest price. Actual price above yhat_upper signals a selling or profit taking opportunity.")
