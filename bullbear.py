...
def safe_trend(x: np.ndarray, y: np.ndarray):
    """Fit a 1-degree poly, fallback to constant mean on failure."""
    try:
...
with tab1:
    ...
    st.info("Select ticker or wait—auto‐loads & auto‐refreshes.")
