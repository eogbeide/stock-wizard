...
# ... (UNCHANGED: remainder of helper/indicator code up to tabs definition)
# NOTE: Batch 1 ends at the end of Tab 4, exactly as requested.
# The tabs list below is UPDATED per your request (removed specified tabs, added new ones).
...
with tab1:
    ...
    if st.session_state.get("run_all", False) and st.session_state.get("ticker") is not None and st.session_state.get("mode_at_run") == mode:
        ...
        # (UNCHANGED: remainder of Tab 1 content)
...
with tab2:
    ...
    if not st.session_state.get("run_all", False) or st.session_state.get("ticker") is None or st.session_state.get("mode_at_run") != mode:
        ...
        if view in ("Intraday", "Both"):
            st.info("Intraday rendering continues unchanged in Batch 2 (per your batching request).")
...
# =========================
# END OF BATCH 1 — through Tabs 1–4
# =========================
# ---------------------------
