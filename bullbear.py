            ...
            if intraday is None or intraday.empty or "Close" not in intraday:
                ...
                try:
                    if np.isfinite(slope_h) and np.isfinite(m_h) and (slope_h * m_h < 0):
                        ...
                        caution_below_btn.warning("ALERT: Please exercise caution while trading at this moment, as the current slope indicates that the dash trendline may be reversing. You can execute the slope reversal trade when the price (blue line) crosses the red downward trendline or the green upward trendline")
                except Exception:
                    pass
