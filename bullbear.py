...
if st.button("Forecast"):
    ...
    # Plot EMA and MA for the forecast period
    ax1.plot(forecast_index, ema_forecast, label='Forecasted 200-Day EMA', color='darkgreen', linestyle='--')
    ...
    forecast_df = pd.DataFrame({
        ...
        'Forecasted EMA': ema_forecast.values,
