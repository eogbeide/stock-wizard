...
if app_mode == "Stock Forecast":
    ...
    symbol = st.sidebar.selectbox(
        "Select Forex Pair:", ['EURUSD=X', 'EURJPY=X', 'GBPUSD=X', 'USDJPY=X', 'AUDUSD=X', 'NZDUSD=X', 'EURCNH=X', 'AUDCNH=X',
                               'USDCAD=X', 'USDCNY=X', 'USDCHF=X', 'EURGBP=X', 'USDHKD=X', 'AUDCNH=X', 'CNHJPY=X']
    )
