...
# =============================================================================
# NEW (This request): Clear cache button (no other behavior changes)
# =============================================================================
if st.button("Clear Cache", key="btn_clear_cache"):
    ...
    # Keep behavior unchanged unless user explicitly clears cache:
    # reset any prior run state so next run refetches fresh data
    st.session_state.run_all = False
    st.session_state.ticker = None
    for _k in ("df_hist", "df_ohlc", "fc_idx", "fc_vals", "fc_ci", "intraday"):
...
# resistance-touch scanner helper (mirror of support-touch)
...
# --- MACD 0-cross + S/R reversal (trend-filtered) signal ---
