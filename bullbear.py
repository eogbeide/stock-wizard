...
with tab1:
    ...
    st.info("Pick a ticker; data refreshes every 120 s.")
    ...
    if st.session_state.run_all and st.session_state.ticker == sel:
        ...
        if chart in ("Hourly","Both"):
            ...
            ax2.set_title(
                f"{sel} Intraday ({hour_range})  ↑{p_up:.1%}  ↓{p_dn:.1%}  Trend: {trend_lbl}"
            )
