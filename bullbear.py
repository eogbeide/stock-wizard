...
if st.button("Forecast"):
    ...
    # Get the current 200-day EMA value, Lower Bollinger Band value, and 30-Day MA value
    ...
    current_moving_average_value = float(moving_average.iloc[-1])  # Get the current 30-Day MA value
