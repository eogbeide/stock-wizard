...
def format_trade_instruction(trend_slope: float,
    ...
    if cs not in ("BUY", "SELL"):
        base_sentence = f"Unconfirmed - Wait for the CONFIRMED signal to place trade • {base_sentence}"
    ...
    if st.session_state.run_all and st.session_state.ticker == sel:
        ...
        if chart in ("Hourly","Both"):
            ...
            if intraday is None or intraday.empty or "Close" not in intraday:
                ...
                # --- PLOT PSAR as a purple line on HOURLY (aligned & on top) ---
...
with tab2:
    ...
    if not st.session_state.run_all:
        ...
        if view in ("Daily","Both"):
            ...
            # --- PLOT PSAR (purple) on Enhanced Daily (aligned & on top) ---
