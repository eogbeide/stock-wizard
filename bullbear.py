...
# - NEW: Normalized Ichimoku on EW panels drawn as **solid black, continuous** line
...
with tab1:
    ...
    if st.session_state.run_all and st.session_state.ticker == sel:
        ...
        if chart in ("Daily","Both"):
            ...
            # NEW: Ichimoku Kijun on Daily price (solid black, continuous)
            ...
            # UPDATED: Normalized Ichimoku as SOLID BLACK, CONTINUOUS
            ...
            ew_sig_d = elliott_conf_signal(px_daily, st.session_state.fc_vals, 0.95)
        ...
        if chart in ("Hourly","Both"):
            ...
            if intraday is None or intraday.empty or "Close" not in intraday:
                ...
                # NEW: Ichimoku Kijun on HOURLY price chart (solid black, continuous)
                ...
                ew_sig_h = elliott_conf_signal(px_intr, st.session_state.fc_vals, 0.95)
...
with tab2:
    ...
    if not st.session_state.run_all:
        ...
        if view in ("Daily","Both"):
            ...
            ew_sig_d2 = elliott_conf_signal(px_daily2, st.session_state.fc_vals, 0.95)
        ...
        if view in ("Intraday","Both"):
            ...
            if intr is None or intr.empty or "Close" not in intr:
                ...
                # NEW: Ichimoku Kijun on HOURLY price (solid black, continuous)
                ...
                ew_sig_h2 = elliott_conf_signal(px_intr2, st.session_state.fc_vals, 0.95)
