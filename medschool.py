...
st.link_button(f"Click here to visit AAMC website for {search_query}", "https://members.aamc.org/eweb/DynamicPage.aspx?site=AAMC&webcode=AAMCOrgSearchResult&orgtype=Medical%20School")
...
filtered_schools_df_sorted = pd.concat([filtered_schools_df[filtered_schools_df['Lab?'] == 'Y'], filtered_schools_df[filtered_schools_df['Lab?'] == 'N']])
