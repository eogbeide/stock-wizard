...
<head>
    ...
    <title>Math and Equations Display</title>
...
<body>
    ...
    <h1>Dynamic Math and Equations Display</h1>
    <input type="text" id="equationInput" placeholder="Enter your LaTeX equation (e.g., \Delta KE = \frac{1}{2} m v^2 - \frac{1}{2} m u^2)">
    <button id="renderButton">Render Equation</button>
